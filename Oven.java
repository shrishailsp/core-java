...
if(isconnected==false){
  isconnected=true;
  System.out.println("the oven is turn on");
  
}
else if(isconnected==true){
     isconnected=false;
	 System.out.println("the oven is turn off");
}
return isconnected;
}
public static void increase(){
 ...
 System.out.println("please turn on oven");
...
public static void decrease(){
  ...
  System.out.println("the mimimumtemp is "+currenttemp);	 
	 ...
	 System.out.println("please on the oven");
